<div style="border-radius: 20px; overflow: hidden; width: fit-content; display: inline-block;">
  <img src="./YoutubeBanner_4-1.png" alt="pixelThreader" />
</div>
...
[![portfolio](https://img.shields.io/badge/my_portfolio-000?style=for-the-badge&logo=ko-fi&logoColor=white)](https://pixelthreader.pro)
...
[![x](https://img.shields.io/badge/X-000000?style=for-the-badge&logo=x&logoColor=white)](https://x.com/_pixelThreader)
...
<p align="center">
    <img src="https://skillicons.dev/icons?i=html,css,tailwind,scss,js,jquery,python,django,php,figma,nextjs,react,appwrite,typescript,git,linux,tensorflow,docker,mongodb,electron,fastapi,flask,latex,notion,postgres,postman,prisma,redis,vite,windows,ubuntu&perline=10" />
</p>
